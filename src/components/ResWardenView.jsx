    ...
    <div style={{ width:'min(1100px,100%)', animation:'slideUp 0.3s ease' }}>
      <div className="desktop-layout">
        <div className="dark-sidebar">
          ...
          <div className="sidebar-profile"><div className="avatar avatar-sm">RI</div><div><strong style={{fontSize:11}}>Prof. R. Iyer</strong><span>{t('role_res_warden', 'Res. Warden')}</span></div></div>
        </div>
