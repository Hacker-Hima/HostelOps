...
export default function LoginPage() {
  ...
  return (
    <div className="login-container">
      ...
      {/* Centralized Glassmorphic Sign-in Card */}
      <div className="login-glass-card">
          ...
          <div className="login-brand-logo-wrap">
            ...
            <div className="login-brand-logo" aria-hidden="true">
              <svg width="32" height="32" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 3L4 11V31C4 32.1 4.9 33 6 33H30C31.1 33 32 32.1 32 31V11L18 3Z" fill="url(#centralBrandGrad)" fillOpacity="0.2" />
                <path d="M18 3L4 11V31C4 32.1 4.9 33 6 33H30C31.1 33 32 32.1 32 31V11L18 3Z" stroke="url(#centralBrandGrad)" strokeWidth="2.2" strokeLinejoin="round" />
                <path d="M18 3V33" stroke="url(#centralBrandGrad)" strokeWidth="1.5" strokeDasharray="2 2" />
                ...
                <path d="M15 33V27H21V33" stroke="url(#centralBrandGrad)" strokeWidth="2" strokeLinecap="round" />
                <circle cx="18" cy="10" r="2.2" fill="#38bdf8" />
                <defs>
                  <linearGradient id="centralBrandGrad" x1="4" y1="3" x2="32" y2="33" gradientUnits="userSpaceOnUse">
        ...
        {GROUPED_ROLES.map(({ category, roles }) => (
          <div key={category} className="login-role-category-section">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          {errorMsg && (
            <div role="alert" style={{ fontSize: 'var(--text-sm)', color: 'var(--color-danger, #ef4444)', background: 'var(--color-danger-soft, rgba(239,68,68,0.12))', border: '1px solid var(--color-danger-border, rgba(239,68,68,0.3))', borderRadius: 'var(--radius-md, 10px)', padding: '10px 14px', marginBottom: '14px', display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
          ...
          {selectedRole && !isLoading && (
            <p style={{ fontSize: '12px', color: 'var(--text-muted, #94a3b8)', textAlign: 'center', marginTop: '12px' }}>
